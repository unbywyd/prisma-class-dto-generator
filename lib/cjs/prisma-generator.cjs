...
var import_generate_class = __toESM(require("./generate-class.cjs"), 1);
var import_generate_enum = __toESM(require("./generate-enum.cjs"), 1);
var import_helpers = require("./helpers.cjs");
var import_project = require("./project.cjs");
var import_removeDir = __toESM(require("./utils/removeDir.cjs"), 1);
...
async function generate(options) {
  ...
  const configFilePath = import_path.default.resolve(schemaDir, configRelativeFilePath, "generator-config.cjson");
