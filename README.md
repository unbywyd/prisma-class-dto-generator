...
A generator for [Prisma ORM](https://www.prisma.io/) that creates fully-typed Data Transfer Objects (DTOs) based on decorators from [`class-validator`](https://github.com/typestack/class-validator) and [`class-transformer`](https://github.com/typestack/class-transformer). It also provides a custom `@Entity` decorator for enhanced type support, enabling correct JSON schema generation. The resulting DTOs are ready for server-side TypeScript applications, and are well-suited for use with frameworks like [`routing-controllers`](https://github.com/typestack/routing-controllers), [`routing-controllers-openapi`](https://github.com/epiphone/routing-controllers-openapi), and [`class-validator-jsonschema`](https://github.com/mbrevda/class-validator-jsonschema).
